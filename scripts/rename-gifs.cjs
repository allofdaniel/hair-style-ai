...
const gifDir = path.join(__dirname, '../public/hairstyles/gif');
...
const nameMap = {
  ...
  '남자 댄디컷': 'm-dandy-cut',
  '남자 드레드락스': 'm-dreadlocks',
  '남자 레이어드컷': 'm-layered-cut',
  '남자 레트로펌': 'm-retro-perm',
  '남자 리젠트컷': 'm-regent-cut',
  '남자 맨번': 'm-man-bun',
  '남자 모히칸': 'm-mohawk',
  '남자 뽀글펌': 'm-ppogle-perm',
  '남자 소프트 투블럭': 'm-soft-two-block',
  '남자 숏컷': 'm-short-cut',
  '남자 쉼표머리': 'm-comma-hair',
  '남자 스왈로펌': 'm-swallow-perm',
  '남자 슬릭백': 'm-slick-back',
  '남자 시스루뱅': 'm-see-through-bang',
  '남자 애즈펌': 'm-as-perm',
  '남자 언더컷': 'm-undercut',
  '남자 울프컷': 'm-wolf-cut',
  '남자 장발': 'm-long-hair',
  '남자 쪽머리': 'm-jjok-hair',
  '남자 츄리닝펌': 'm-churning-perm',
  '남자 크롭컷': 'm-crop-cut',
  '남자 크루컷': 'm-crew-cut',
  '남자 투블럭': 'm-two-block',
  '남자 퐁퍼두르': 'm-pompadour',
  ...
  '남자 호스트클럽 스타일': 'm-host-club-style',
  '남자 롱레이어드': 'm-long-layered',
  '남자 브라질 서퍼': 'm-brazil-surfer',
  '남자 라틴 페이드': 'm-latin-fade',
  '남자 아프리칸 페이드': 'm-african-fade',
  '남자 미들파트 롱': 'm-middle-part-long',
  '남자 플로우컷': 'm-flow-cut',
  '남자 텍스처드 크롭': 'm-textured-crop',
  '남자 사이드파트': 'm-side-part',
  '남자 버즈컷': 'm-buzz-cut',
  '남자 스파이크': 'm-spike',
  '남자 프렌치크롭': 'm-french-crop',
  '남자 콘로우': 'm-cornrows',
  '남자 박스브레이드': 'm-box-braids',
  '남자 트위스트아웃': 'm-twist-out',
  ...
  // 여자 스타일
  '여자 360 웨이브': 'f-360-wave',
  '여자 C컬펌': 'f-c-curl-perm',
  '여자 S컬펌': 'f-s-curl-perm',
  '여자 가르마펌': 'f-parted-perm',
  '여자 글램웨이브': 'f-glam-wave',
  '여자 내추럴 스트레이트': 'f-natural-straight',
  '여자 단발': 'f-bob-cut',
  '여자 댄서웨이브': 'f-dancer-wave',
  '여자 레이어드컷': 'f-layered-cut',
  '여자 롱 S컬펌': 'f-long-s-curl-perm',
  '여자 롱 레이어드': 'f-long-layered',
  '여자 롱 웨이브': 'f-long-wave',
  '여자 롱 스트레이트': 'f-long-straight',
  '여자 미디엄 레이어드': 'f-medium-layered',
  '여자 바디펌': 'f-body-perm',
  '여자 반묶음': 'f-half-up',
  '여자 발레리나번': 'f-ballerina-bun',
  '여자 뱅헤어': 'f-full-bangs',
  '여자 보브컷': 'f-bob-cut',
  '여자 볼륨펌': 'f-volume-perm',
  '여자 볼륨매직': 'f-volume-magic',
  '여자 빌드펌': 'f-build-perm',
  '여자 세팅펌': 'f-setting-perm',
  '여자 숏컷': 'f-short-cut',
  '여자 숏단발': 'f-short-bob',
  '여자 슬릭백': 'f-slick-back',
  '여자 시스루뱅': 'f-see-through-bang',
  '여자 애즈펌': 'f-as-perm',
  '여자 업스타일': 'f-updo',
  '여자 울프컷': 'f-wolf-cut',
  '여자 웨이브롱': 'f-wave-long',
  ...
  '여자 트윈테일': 'f-twin-tail',
  '여자 포니테일': 'f-ponytail',
  '여자 플리츠펌': 'f-pleats-perm',
  '여자 허쉬컷': 'f-hush-cut',
  '여자 히피펌': 'f-hippie-perm',
  '여자 히메컷': 'f-hime-cut',
  '여자 단발 뱅헤어': 'f-bob-with-bangs',
  '여자 쵸피밥': 'f-choppy-bob',
  '여자 디지털펌': 'f-digital-perm',
  '여자 여신웨이브': 'f-goddess-wave',
  '여자 울짱스타일': 'f-ulzzang-style',
  '여자 롱밥 뱅헤어': 'f-long-bob-with-bangs',
  '여자 픽시컷': 'f-pixie-cut',
  '여자 모로칸 스타일': 'f-moroccan-style',
  '여자 터키시 드라마': 'f-turkish-drama',
  '여자 페르시안 컬': 'f-persian-curl',
  '여자 인디안 롱': 'f-indian-long',
  '여자 볼리우드 글램': 'f-bollywood-glam',
  '여자 필리핀 웨이브': 'f-philippine-wave',
  '여자 푸에르토리코 코일리': 'f-puerto-rican-coily',
  '여자 콜롬비안 웨이브': 'f-colombian-wave',
  '여자 라티나 컬': 'f-latina-curl',
  '여자 브라질리언 블로우아웃': 'f-brazilian-blowout',
  '여자 콘로우': 'f-cornrows',
  '여자 박스브레이드': 'f-box-braids',
  '여자 반투노트': 'f-bantu-knots',
  '여자 세네갈 트위스트': 'f-senegal-twist',
  '여자 트위스트 아웃': 'f-twist-out',
  '여자 블런트컷': 'f-blunt-cut',
  '여자 C컬': 'f-c-curl',
  '여자 중국 고대 업두': 'f-chinese-ancient-updo',
  '여자 일본 애니메 트윈테일': 'f-anime-twintail',
  '여자 아라비안 롱': 'f-arabian-long',
...
files.forEach(file => {
  ...
  const englishName = nameMap[baseName];

  if (englishName) {
    const oldPath = path.join(gifDir, file);
    const newPath = path.join(gifDir, `${englishName}.gif`);

    if (!fs.existsSync(newPath)) {
      fs.renameSync(oldPath, newPath);
      console.log(`✅ ${baseName} -> ${englishName}.gif`);
      renamed++;
    } else {
      console.log(`⏭️ Skip (exists): ${englishName}.gif`);
    }
  } else {
