...
const PAGE_TITLES: Record<Language, Record<string, string>> = {
  ko: {
    home: 'BeforeCut - AI 헤어스타일 시뮬레이터 | 무료 가상 헤어 체험',
    camera: '사진 촬영 | BeforeCut',
    result: '시뮬레이션 결과 | BeforeCut',
    custom: '커스텀 스타일 | BeforeCut',
    analysis: '얼굴형 분석 | BeforeCut',
    settings: '설정 | BeforeCut',
    history: '히스토리 | BeforeCut',
  },
  en: {
    home: 'BeforeCut - AI Hair Simulator | Free Virtual Hair Try-On',
    camera: 'Take Photo | BeforeCut',
    result: 'Simulation Result | BeforeCut',
    custom: 'Custom Style | BeforeCut',
    analysis: 'Face Analysis | BeforeCut',
    settings: 'Settings | BeforeCut',
    history: 'History | BeforeCut',
  },
  zh: {
    home: 'BeforeCut - AI发型模拟器 | 免费虚拟发型体验',
    camera: '拍照 | BeforeCut',
    result: '模拟结果 | BeforeCut',
    custom: '自定义风格 | BeforeCut',
    analysis: '脸型分析 | BeforeCut',
    settings: '设置 | BeforeCut',
    history: '历史记录 | BeforeCut',
  },
  ja: {
    home: 'BeforeCut - AIヘアスタイルシミュレーター | 無料バーチャルヘア体験',
    camera: '写真を撮る | BeforeCut',
    result: 'シミュレーション結果 | BeforeCut',
    custom: 'カスタムスタイル | BeforeCut',
    analysis: '顔の分析 | BeforeCut',
    settings: '設定 | BeforeCut',
    history: '履歴 | BeforeCut',
  },
  es: {
    home: 'BeforeCut - Simulador de Peinados con IA | Prueba Virtual Gratis',
    camera: 'Tomar Foto | BeforeCut',
    result: 'Resultado de Simulación | BeforeCut',
    custom: 'Estilo Personalizado | BeforeCut',
    analysis: 'Análisis Facial | BeforeCut',
    settings: 'Configuración | BeforeCut',
    history: 'Historial | BeforeCut',
  },
  pt: {
    home: 'BeforeCut - Simulador de Cabelo com IA | Teste Virtual Grátis',
    camera: 'Tirar Foto | BeforeCut',
    result: 'Resultado da Simulação | BeforeCut',
    custom: 'Estilo Personalizado | BeforeCut',
    analysis: 'Análise Facial | BeforeCut',
    settings: 'Configurações | BeforeCut',
    history: 'Histórico | BeforeCut',
  },
  fr: {
    home: 'BeforeCut - Simulateur de Coiffure IA | Essai Virtuel Gratuit',
    camera: 'Prendre une Photo | BeforeCut',
    result: 'Résultat de Simulation | BeforeCut',
    custom: 'Style Personnalisé | BeforeCut',
    analysis: 'Analyse du Visage | BeforeCut',
    settings: 'Paramètres | BeforeCut',
    history: 'Historique | BeforeCut',
  },
  de: {
    home: 'BeforeCut - KI-Frisuren-Simulator | Kostenlose Virtuelle Frisur',
    camera: 'Foto aufnehmen | BeforeCut',
    result: 'Simulationsergebnis | BeforeCut',
    custom: 'Benutzerdefinierter Stil | BeforeCut',
    analysis: 'Gesichtsanalyse | BeforeCut',
    settings: 'Einstellungen | BeforeCut',
    history: 'Verlauf | BeforeCut',
  },
  th: {
    home: 'BeforeCut - จำลองทรงผม AI | ทดลองทรงผมเสมือนจริงฟรี',
    camera: 'ถ่ายรูป | BeforeCut',
    result: 'ผลการจำลอง | BeforeCut',
    custom: 'สไตล์กำหนดเอง | BeforeCut',
    analysis: 'วิเคราะห์ใบหน้า | BeforeCut',
    settings: 'การตั้งค่า | BeforeCut',
    history: 'ประวัติ | BeforeCut',
  },
  vi: {
    home: 'BeforeCut - Mô phỏng Kiểu tóc AI | Thử Tóc Ảo Miễn phí',
    camera: 'Chụp Ảnh | BeforeCut',
    result: 'Kết quả Mô phỏng | BeforeCut',
    custom: 'Phong cách Tùy chỉnh | BeforeCut',
    analysis: 'Phân tích Khuôn mặt | BeforeCut',
    settings: 'Cài đặt | BeforeCut',
    history: 'Lịch sử | BeforeCut',
  },
  id: {
    home: 'BeforeCut - Simulator Rambut AI | Coba Rambut Virtual Gratis',
    camera: 'Ambil Foto | BeforeCut',
    result: 'Hasil Simulasi | BeforeCut',
    custom: 'Gaya Kustom | BeforeCut',
    analysis: 'Analisis Wajah | BeforeCut',
    settings: 'Pengaturan | BeforeCut',
    history: 'Riwayat | BeforeCut',
  },
  hi: {
    home: 'BeforeCut - AI हेयर सिम्युलेटर | मुफ्त वर्चुअल हेयर ट्राई-ऑन',
    camera: 'फोटो लें | BeforeCut',
    result: 'सिमुलेशन परिणाम | BeforeCut',
    custom: 'कस्टम स्टाइल | BeforeCut',
    analysis: 'फेस एनालिसिस | BeforeCut',
    settings: 'सेटिंग्स | BeforeCut',
    history: 'इतिहास | BeforeCut',
  },
  ar: {
    home: 'BeforeCut - محاكي تسريحات الشعر بالذكاء الاصطناعي | تجربة شعر افتراضية مجانية',
    camera: 'التقاط صورة | BeforeCut',
    result: 'نتيجة المحاكاة | BeforeCut',
    custom: 'نمط مخصص | BeforeCut',
    analysis: 'تحليل الوجه | BeforeCut',
    settings: 'الإعدادات | BeforeCut',
    history: 'السجل | BeforeCut',
  },
};
...
const PAGE_DESCRIPTIONS: Record<Language, Record<string, string>> = {
  ko: {
    ...
    settings: 'BeforeCut 앱 설정을 관리하세요.',
  ...
  en: {
    ...
    settings: 'Manage your BeforeCut app settings.',
  ...
  es: {
    ...
    settings: 'Administra la configuración de tu app BeforeCut.',
  ...
  pt: {
    ...
    settings: 'Gerencie as configurações do app BeforeCut.',
  ...
  fr: {
    ...
    settings: 'Gérez les paramètres de l\'application BeforeCut.',
  ...
  de: {
    ...
    settings: 'Verwalten Sie Ihre BeforeCut-App-Einstellungen.',
  ...
  th: {
    ...
    settings: 'จัดการการตั้งค่าแอป BeforeCut',
  ...
  vi: {
    ...
    settings: 'Quản lý cài đặt ứng dụng BeforeCut.',
  ...
  id: {
    ...
    settings: 'Kelola pengaturan aplikasi BeforeCut.',
  ...
  hi: {
    ...
    settings: 'BeforeCut ऐप सेटिंग्स प्रबंधित करें।',
  ...
  ar: {
    ...
    settings: 'إدارة إعدادات تطبيق BeforeCut.',
...
export const getPageTitle = (page: string, language: Language): string => {
  return PAGE_TITLES[language]?.[page] || PAGE_TITLES.en[page] || 'BeforeCut';
};
...
export const initPageSEO = (options: {
  ...
  if (page === 'home') {
    const structuredData = generateStructuredData({
      type: 'WebApplication',
      name: 'BeforeCut - AI Hair Simulator',
